    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TextView class_subject=(TextView)view.findViewById(R.id.class_subject);
                Intent intent = new Intent(AttendanceActivity.this,StudentListActivity.class);
                intent.putExtra("year", String.valueOf(class_year.getText()));
                intent.putExtra("branch", String.valueOf(class_branch.getText()));
                intent.putExtra("section", String.valueOf(class_section.getText()));
                intent.putExtra("subject", String.valueOf(class_subject.getText()));
