...
public class FacultyStatisticsDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_statistics_details);
        ...
        ListView1 = findViewById(R.id.ListView6);
        ListView1.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
        list = new ArrayList<>();
        adapter = new StudentsAdapter(this, R.layout.list_students_statistics, list);
        ...
        ListView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(FacultyStatisticsDetails.this, FacultyStatisticsResult.class);
