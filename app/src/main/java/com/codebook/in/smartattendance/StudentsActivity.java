...
public class StudentsActivity extends AppCompatActivity {
    ...
    result -> {
        if (result.getResultCode() == Activity.RESULT_OK) {
            ...
            ReadExcelFile(StudentsActivity.this
                    , uri);
    ...
    public void FillList() {
        try {
            if (controller == null) {
                DBHelper controller = new DBHelper(StudentsActivity.this);
            }
            ArrayList<HashMap<String, String>> myList = controller.getProducts();
            if (myList.size() != 0) {
                lv = findViewById(R.id.ListView3);
                ListAdapter adapter = new SimpleAdapter(StudentsActivity.this, myList,
                        R.layout.list_students, new String[]{DBHelper.Rollno, DBHelper.Name, DBHelper.Year, DBHelper.Branch, DBHelper.Section, DBHelper.Subject},
                        new int[]{R.id.student_rollno, R.id.student_name, R.id.class_year,R.id.class_branch,R.id.class_section,R.id.class_subject});
    ...
    public void ReadExcelFile(StudentsActivity context, Uri uri) {
        try {
...
//                lbl.setText("First " + e.getMessage().toString());
    ...
    void Toast(String message, Exception ex) {
        ...
        Toast.makeText(StudentsActivity.this, message, Toast.LENGTH_LONG).show();
